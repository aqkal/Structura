        ...
        {consentOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="glass-strong relative z-10 flex w-full max-w-md flex-col gap-4 rounded-[var(--radius-lg)] p-6 shadow-[var(--shadow-card)]"
            >
              <h2 className="font-semibold text-[color:var(--color-ink)] text-[var(--text-lg)]">
                Before you create your account
              </h2>
              <p className="leading-relaxed text-[color:var(--color-ink-muted)] text-[var(--text-sm)]">
                You must be at least 13 to use Qualia. Please confirm and accept
                to continue.
              </p>
              <label className="flex items-start gap-2.5 text-[color:var(--color-ink-muted)] text-[var(--text-sm)]">
                <input
                  type="checkbox"
                  checked={agreed}
                  onChange={(e) => setAgreed(e.target.checked)}
                  className="mt-0.5 h-4 w-4 shrink-0 accent-[color:var(--mint-700)]"
                />
                <span>
